...
- Keep pip packages as-is — they'll be installed via pipx by the engine
- Comments in YAML to explain non-obvious choices
  ...
  <done>template.yaml contains complete forge-shield config with all packages, container settings, user config, env vars, and hook references.</done>
  </task>

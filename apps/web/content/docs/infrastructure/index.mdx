...
description: LXC containers with git-based configuration management for reproducible, version-controlled development environments.
---

## Overview

The infrastructure layer provides reproducible, version-controlled development environments using LXC containers with git-based configuration management. Everything is defined as code — packages, scripts, configuration files — enabling instant environment recreation and team standardization.
...
Comprehensive documentation for all aspects of the LXC infrastructure:

- [**LXC Setup**](/docs/infrastructure/lxc-setup) — Installation, quick start, resource requirements, first-boot walkthrough, and creating custom templates
- [**LXC Configuration**](/docs/infrastructure/lxc-configuration) — Complete reference for config-manager: scripts, files, packages, snapshots, conflict resolution, and advanced topics
- [**LXC Credentials**](/docs/infrastructure/lxc-credentials) — Credential management, password rotation, security best practices for web services
- [**LXC Migration**](/docs/infrastructure/lxc-migration) — Migrating from Coder workspaces, Docker Compose, bare-metal setups, and cloud IDEs with step-by-step guides
- [**LXC Troubleshooting**](/docs/infrastructure/lxc-troubleshooting) — Common issues, diagnostic commands, and solutions for service failures, git sync problems, and performance issues
...
See [LXC Troubleshooting](/docs/infrastructure/lxc-troubleshooting) for detailed solutions.
...
- **New to LXC?** Start with [LXC Setup](/docs/infrastructure/lxc-setup) for installation and quick start
- **Customizing configs?** See [LXC Configuration](/docs/infrastructure/lxc-configuration) for complete reference
- **Migrating?** Check [LXC Migration](/docs/infrastructure/lxc-migration) for step-by-step guides
- **Having issues?** Consult [LXC Troubleshooting](/docs/infrastructure/lxc-troubleshooting) for solutions
